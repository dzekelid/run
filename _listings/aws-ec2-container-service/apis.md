...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/run/master/_listings/aws-ec2-container-service/apis.md
...
- name: AWS EC2 Container Service API - Create Service
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/run/master/_listings/aws-ec2-container-service/actioncreateservice-get-openapi.md
- name: AWS EC2 Container Service API - Run Task
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/run/master/_listings/aws-ec2-container-service/actionruntask-get-openapi.md
x-common:
- type: x-api-gallery
