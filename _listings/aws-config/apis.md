...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/run/master/_listings/aws-config/apis.md
...
- name: AWS Config API - Start Config Rules Evaluation
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/run/master/_listings/aws-config/actionstartconfigrulesevaluation-get-openapi.md
x-common:
- type: x-api-gallery
