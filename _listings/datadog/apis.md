...
created: "2018-08-26"
modified: "2018-08-26"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/run/master/_listings/datadog/apis.md
...
- name: DataDog Merged API - Add Check Run
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/run/master/_listings/datadog/check-run-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/run/master/_listings/datadog/check-run-post-openapi.md
x-common:
- type: x-api-gallery
